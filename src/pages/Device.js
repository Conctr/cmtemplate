...
export default class DevicePage extends Component {
    ...
    handleUpdateData = (newData) => {
        this.setState({
            data: this.state.data ? this.state.data.concat(newData) : [newData]
        })
    }
                    ...
                    <div style={{textAlign: 'center', marginLeft: 'auto', marginRight: 'auto'}}>
                        ...
                        <div style={{width: '100%', display: 'block'}}>
                            {!this.state.loaderShown ? (
                                <div style={{
                                    ...
                                    }}>{`Data range: ${this.state.hoursBackShown} hours`}</h5>
                                    <Slider style={{width: '85%', display: 'inline-block'}}
                                            ...
                                            onDragStop={() => {
                                                this.defaultChange > 0 && this.handleSliderStop(this.defaultChange)
                                            }}
                                    />
                                </div>
                            ) : (
                        ...
                        {this.state.graphsShown.map(graphPreference => (
                            ...
                            <div style={{
                                ...
                                <LineGraph graphPreference={graphPreference}
                                           values={sortedData[graphPreference.key].values}/>
                            </div>
                        ))}</div>
                ) : <CircularProgress/>}
            </div>
