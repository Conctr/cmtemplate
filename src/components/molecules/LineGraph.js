...
export default class NavBar extends React.Component {
  ...
  render() {
    ...
    if (
      ...
      this.props.rangeY.max < this.props.upperlimit
    ) {
    ...
    if (
      ...
      this.props.rangeY.min > this.props.lowerlimit
    ) {
    ...
    return (
      <div>
        {!!this.props.lowerlimit ? (
          <p>
            {" "}
            Low {this.props.graphPreference.displayTitle} warning:{" "}
            {this.props.lowerlimit}{" "}
          </p>
        ) : (
          false
        ...
        {!!this.props.upperlimit ? (
          <p>
            {" "}
            High {this.props.graphPreference.displayTitle} warning:{" "}
            {this.props.upperlimit}
          </p>
        ) : (
          false
        ...
        <VictoryChart
          ...
          domain={{
            x: [this.props.rangeX.min, this.props.rangeX.max],
            y: [yAxisMin, yAxisMax]
          }}
          domainPadding={30}
        >
          {!!this.props.upperlimit ? (
            <VictoryArea
              ...
              data={[
                {
                  x: moment(this.props.values[this.props.values.length - 1].ts)
                    .subtract(30, "minutes")
                    .toDate(),
                  y: this.props.upperlimit
                },
                {
                  x: moment(this.props.values[0].ts)
                    .add(30, "minutes")
                    .toDate(),
                  y: this.props.upperlimit
                }
          ...
          <VictoryAxis
            dependentAxis
            label={`${this.props.graphPreference.displayTitle} (${
              this.props.graphPreference.unit
            })`}
            style={{
          ...
          <VictoryScatter
            ...
            labels={d => {
              return `${moment(d.x).format("h[:]mm A")}
                ${this.props.graphPreference.displayTitle}: ${d.y.toFixed(2)}${
                this.props.graphPreference.unit
              }`
            }}
          />
